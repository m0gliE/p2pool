...
nets = dict(
    ...
    diamond=math.Object(
        P2P_PREFIX='e4e8dbfd'.decode('hex'),
        P2P_PORT=17771,
        ADDRESS_VERSION=35,
        RPC_PORT=17772,
        RPC_CHECK=defer.inlineCallbacks(lambda bitcoind: defer.returnValue(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://www.diamondblocks.info/block/',
        ADDRESS_EXPLORER_URL_PREFIX='http://www.diamondblocks.info/address/',
        TX_EXPLORER_URL_PREFIX='http://www.diamondblocks.info/tx/',
        SANE_TARGET_RANGE=(2**256//100000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8
    ),
